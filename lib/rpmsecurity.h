 ...
 * @param sig		PGP digest parameter
 * @param rpmrc		success from RPM
 * @return		    RPMRC_OK on success, RPMRC_FAIL otherwise
 */
 ...
 * @param dirName   file directory name from fsm->dirName
 * @param baseName  file base name from fsm->baseName
 * @return          RPMRC_OK on success, RPMRC_FAIL otherwise
 */
 ...
 * @param st		file stat structure pointer from fsm->sb
 * @param buf		rpm read buffer from fsm->buf
 * @param len		the actual number of bytes in the buffer 
 * @return		    RPMRC_OK on success, RPMRC_FAIL otherwise
 */
